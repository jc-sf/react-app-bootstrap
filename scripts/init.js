...
module.exports = function(
  ...
  // shell.cd(cdpath);
  // console.log(chalk.blue(`Start setting up SLDS assets`));
  ...
  // shell.cp(
  //   '-r',
  //   'node_modules/@salesforce/design-system-react/assets/icons',
  //   'public/assets'
  // );
  ...
  // shell.cp(
  //   '-r',
  //   'node_modules/@salesforce/design-system-react/assets/images',
  //   'public/assets'
  // );
